    ...
    public class Player
    {
        ...
        public bool HasWon()
        {
            ...
            for(int matchRank = 0; matchRank < 13; matchRank++)
            {
                ...
                if(cardsOfRank == 3)
                {
                    // Two threes means no win possible(threeOfKind will
                    // be true only if this code has already executed).
            ...
            // -two sets of three hace been found, losing.
            ...
            if(tempHand.Count == 7)
            {
                ...
                // create two temportary sets for checking.
                ...
                if(threeSuit == fourSuit)
                {
                    ...
                    if(tempHand.Count != 1)
                    {
                        // if more than one card is left then three aren't two runs.
                        return false;
                    }
                        ...
                        || (tempHand[0].rank ==(Rank)(maxVal - 3)))
                    {
                        ...
                        // four card set then there are sets.
                        return true;
                    }
                    else
                    {
